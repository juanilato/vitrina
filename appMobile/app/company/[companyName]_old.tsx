...
import { textStyles, spacing, borderRadius } from '../../src/theme';
...
const createStyles = (colors: any, isDark: boolean) => StyleSheet.create({
  ...
  // Category chips premium y sutiles
