...
export class ValoracionesController {
  ...
  async create(@Body() createValoracionDto: CreateValoracionDto, @Request() req) {
    ...
    return this.valoracionesService.create(createValoracionDto, req.user.userId);
  }
  ...
  async canBeRated(@Param('pedidoId') pedidoId: string, @Request() req) {
    ...
    return this.valoracionesService.canBeRated(pedidoId, req.user.userId);
  }
  ...
  async findMyValoraciones(@Request() req) {
    ...
    return this.valoracionesService.findByCliente(req.user.userId);
  }
  ...
  async update(
    ...
    return this.valoracionesService.update(id, updateValoracionDto, req.user.userId);
  }
}
